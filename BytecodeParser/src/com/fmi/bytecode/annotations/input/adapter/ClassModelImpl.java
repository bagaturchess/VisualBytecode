...
import com.fmi.bytecode.parser.internal.ClassFile;
    ...
    implements ClassModel
{
    ...
    private void parseFields()
    {
        ...
        com.fmi.bytecode.parser.internal.FieldInfo bmFields[] = classFile.getFieldsArray();
        com.fmi.bytecode.parser.internal.FieldInfo afieldinfo[] = bmFields;
        int i = 0;
        for(int j = afieldinfo.length; i < j; i++)
        {
            com.fmi.bytecode.parser.internal.FieldInfo f = afieldinfo[i];
