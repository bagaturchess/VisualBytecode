        ...
        for(int i = 0; i < identifiers.length; i++)
        {
            ...
            if(path.length != 0)
            {
                ...
                if(s.startsWith("{method}"))
                {
                    ...
                    com.fmi.bytecode.parser.MethodInfo method = cf.getMethod(identifiers[i].substring(indexOfDot + 1, indexOfOpeningBracket), identifiers[i].substring(indexOfOpeningBracket));
                    if(method == null)
