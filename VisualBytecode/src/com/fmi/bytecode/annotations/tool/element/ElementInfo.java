...
public interface ElementInfo {
	 ...
	 * a <code>com.fmi.bytecode.annotations.tool.element.AnnotationRecord<code> object as a value.
	 * 
	 * @return Immutable Map with an annotation type as a key and 
	 * a <code>com.fmi.bytecode.annotations.tool.element.AnnotationRecord<code> object as a value.
	 * Empty map is retuned if no annotations are declared. 
	 * @see com.fmi.bytecode.annotations.tool.element.AnnotationRecord.Annotation
	 */
