 ...
 * the <code>com.fmi.bytecode.annotations.tool.element.ClassInfo</code> interface
 * 
...
public class ClassInfoImpl extends ElementInfoImpl implements ClassInfo {
	...
	public com.fmi.bytecode.annotations.tool.element.MethodInfo[] getMethods() {
		return methods;
	}
	
	public com.fmi.bytecode.annotations.tool.element.MethodInfo[] getMethodStartingWith(String methodName) {
        ArrayList<com.fmi.bytecode.annotations.tool.element.MethodInfo> result = 
        	new ArrayList<com.fmi.bytecode.annotations.tool.element.MethodInfo>();
        for(com.fmi.bytecode.annotations.tool.element.MethodInfo m: methods){
        ...
        if(result.size()==0){
            ...
            return result.toArray(new com.fmi.bytecode.annotations.tool.element.MethodInfo[result.size()]);
        }
	}	

	public com.fmi.bytecode.annotations.tool.element.MethodInfo[] getMethod(String methodName) {
        ArrayList<com.fmi.bytecode.annotations.tool.element.MethodInfo> result = new ArrayList<com.fmi.bytecode.annotations.tool.element.MethodInfo>();
        for(com.fmi.bytecode.annotations.tool.element.MethodInfo m: methods){
	...
	public com.fmi.bytecode.annotations.tool.element.MethodInfo getMethod(String methodName, String[] parameterTypes) {
        for(com.fmi.bytecode.annotations.tool.element.MethodInfo m: methods){            
            if(m.getName().equals(methodName)){
	...
	public com.fmi.bytecode.annotations.tool.element.FieldInfo[] getFields() {		
		return fields.values().toArray(new FieldInfoImpl[fields.size()]);
	}
	
	public com.fmi.bytecode.annotations.tool.element.FieldInfo getField(String fieldName) {		
